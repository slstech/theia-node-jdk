...
RUN echo "deb https://adoptopenjdk.jfrog.io/adoptopenjdk/deb bionic main" | tee /etc/apt/sources.list.d/adoptopenjdk.list
RUN apt-get update && apt-get -y install adoptopenjdk-11-hotspot maven gradle
